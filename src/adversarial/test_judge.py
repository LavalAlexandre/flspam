...
from src.adversarial.rl_simple import CombinedReward, parse_judge_score  # noqa: E402
...
class TestJudgeScoring(unittest.TestCase):
    def setUp(self):
        ...
        with patch(
            "src.adversarial.rl_simple.CombinedReward.__init__", return_value=None
        ):
    ...
    def test_judge_scoring_slicing(self, mock_profiler):
        ...
        self.assertTrue(
            torch.equal(call_args[0][0], generated_ids[0]),
    ...
    def test_parse_judge_score(self):
        ...
        self.assertEqual(
            parse_judge_score('Some text {"score": 7, "reason": "ok"} end'), 0.7
        )

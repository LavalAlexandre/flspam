...
class TestDistributeSpamIID:
    ...
    def test_iid_distributes_to_all_personas(
        self, sample_spam_messages, sample_persona_ids
    ):
    ...
    def test_iid_distributes_all_messages(
        self, sample_spam_messages, sample_persona_ids
    ):
    ...
    def test_iid_roughly_equal_distribution(
        self, sample_spam_messages, sample_persona_ids
    ):
    ...
    def test_iid_deterministic_with_seed(
        self, sample_spam_messages, sample_persona_ids
    ):
    ...
    def test_iid_different_seeds_different_results(
        self, sample_spam_messages, sample_persona_ids
    ):
...
class TestDistributeSpamDirichlet:
    ...
    def test_dirichlet_distributes_to_all_personas(
        self, sample_spam_messages, sample_persona_ids
    ):
    ...
    def test_dirichlet_distributes_all_messages(
        self, sample_spam_messages, sample_persona_ids
    ):
        """All spam messages should be distributed (no loss)."""
        result = distribute_spam(
...
class TestMessageIntegrity:
    ...
    def test_distributed_messages_reference_originals(
        self, sample_spam_messages, sample_persona_ids
    ):
